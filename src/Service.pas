...
type
  ...
  TService<T> = class(TInterfacedObject, IService<T>)
  private
    function GetUnitOfWork: TUnitOfWork;
  public
    property UoW: TUnitOfWork read GetUnitOfWork;
...
function TService<T>.IsAuthorized(APermissionType: TPermissionType; APermissionControl: Boolean; AShowException: Boolean=True): Boolean;
begin
